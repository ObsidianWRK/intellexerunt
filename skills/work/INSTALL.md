...
Use when the user asks to implement, build, code, develop, create, or write code. Triggers on "fix t
...
```bash
cp -r skills/work .claude/skills/work
```
...
1. Zip the skill folder: `cd skills && zip -r work.zip work/`
...
```bash
cp -r skills/work .cursor/skills/work
```
...
```bash
cp -r skills/work .agents/skills/work
```
...
```bash
cp -r skills/work .github/skills/work
```
...
```bash
cp -r skills/work .gemini/skills/work
```
