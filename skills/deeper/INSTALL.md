...
Use when the user wants to investigate, research, explore, dig into, or understand something deeply.
...
```bash
cp -r skills/deeper .claude/skills/deeper
```
...
1. Zip the skill folder: `cd skills && zip -r deeper.zip deeper/`
...
```bash
cp -r skills/deeper .cursor/skills/deeper
```
...
```bash
cp -r skills/deeper .agents/skills/deeper
```
...
```bash
cp -r skills/deeper .github/skills/deeper
```
...
```bash
cp -r skills/deeper .gemini/skills/deeper
```
