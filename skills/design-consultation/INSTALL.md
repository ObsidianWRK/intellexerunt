# Installing `design-consultation`

Use when the user asks for design system work, competitor analysis, UI patterns, or visual design. T
...
```bash
cp -r skills/design-consultation .claude/skills/design-consultation
```
...
1. Zip the skill folder: `cd skills && zip -r design-consultation.zip design-consultation/`
...
```bash
cp -r skills/design-consultation .cursor/skills/design-consultation
```
...
```bash
cp -r skills/design-consultation .agents/skills/design-consultation
```
...
```bash
cp -r skills/design-consultation .github/skills/design-consultation
```
...
```bash
cp -r skills/design-consultation .gemini/skills/design-consultation
```
