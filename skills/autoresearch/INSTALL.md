# Installing `autoresearch`

Use when the user asks for autonomous iteration, overnight improvement, security audit, self-improvi
...
1. Zip the skill folder: `cd skills && zip -r autoresearch.zip autoresearch/`
...
```bash
cp -r skills/autoresearch .cursor/skills/autoresearch
```
...
```bash
cp -r skills/autoresearch .agents/skills/autoresearch
```
...
```bash
cp -r skills/autoresearch .github/skills/autoresearch
```
...
```bash
cp -r skills/autoresearch .gemini/skills/autoresearch
```
